...
namespace TeeJee.GtkHelper {
    ...
    public string gtk_combobox_get_value (ComboBox combo, int index, string default_value) {
        ...
        if ((combo.model == null) || (combo.active < 0)) {
    ...
    public GLib.Object gtk_combobox_get_selected_object (ComboBox combo,
                                                         int index,
    ...
    public Gtk.MenuItem gtk_menu_add_item (Gtk.Menu menu,
                                           string label,
                                           string tooltip,
